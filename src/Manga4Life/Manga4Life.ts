...
const SOURCE_DOMAIN = "https://manga4life.com/"

export class Manga4Life extends Source {
    ...
    get description(): string { return 'a manga4life extension' }
    get author(): string { return 'Abyss' }
